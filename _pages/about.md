...
* Can we just agree that convolutional Neural networks are super fun?! One of the projects I have enjoyed the most whilst working on it aimed to [detect pneumonia with a CNN](https://github.com/cuspime/Projects/blob/master/ChestXRays.ipynb). By making use of a kaggle dataset and several modules and functions of the Tensorflow, Keras and sklearn libraries to preprocess the data, I came up with a CNN that was able to predict whether or not a patient had pneumonia with an 88.9% accuracy and an f1 score of  of about 0.914.
...
* Now, I currently live in Italy and before moving in here, I decided to make a little research about the basics of the country, like the population, income, the behaviour of money spenditure, the price of houses by region and car accidents geographical distribution. I mean, one can never be too informed about these matters.
...
<iframe src="https://www.youtube.com/embed/aircAruvnKk"  width="80" height="40"  frameborder="0" style="-webkit-transform:scale(0.7);-moz-transform-scale(0.9);" ></iframe>
